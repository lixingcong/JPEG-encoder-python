#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Time-stamp: < entropy_encode.py 2016-05-07 16:35:18 >
"""
熵编码
""" 
...
def get_entropy_encode(input_list):
	...
	for ac_item in input_list[1:-1]:
		...
		# 把0游程转字符串
		if ac_zero_counter > 9:
			ac_zero_counter = map_z(ac_zero_counter)
		else:
			ac_zero_counter = str(ac_zero_counter)
		ac_bit = ac_item[1]
		ac_amp = ac_item[2]
		...
		if ac_bit > 9:
			...
			ac_bit = str(ac_bit)
		# 查表
		coefficient = huffman_AC_chrominance_table[ac_zero_counter + "/" + ac_bit]
